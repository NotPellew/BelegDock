...
auch wenn ein anderer Zustellnachweis-Pfad angegeben wird. Ein abstürzender
Prozess hinterlässt `send_pending`; das Remote-Ergebnis ist dann unbekannt und
darf nicht durch erneutes Senden getestet werden.
