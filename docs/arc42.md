...
uses an exclusive, atomically updated receipt to prevent concurrent sends and
preserve uncertain outcomes. Receipt states distinguish definitive rejection,
ambiguous send, and sent-with-unknown-label outcomes. The tooling proves
repeatable test setup, not invoice validity or completed bookkeeping.
